...
param max{i in D, j in Z};
/* capacity of zmiana and dzielnica */

param min{j in Z, i in D};
...
set I := Seattle San-Diego; /* canning plants - daje */

set J := New-York Chicago Topeka; /* markets - wymaga */
